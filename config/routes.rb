...
match '/attachments/:id/vote_down1b/', :to=>'attachments#vote_down1b'
...
match '/attachments/:id/vote_up2b/', :to=>'attachments#vote_up2b'
match '/attachments/:id/vote_down2b/', :to=>'attachments#vote_down2b'
...
match '/attachments/:id/vote_up3b/', :to=>'attachments#vote_up3b'
match '/attachments/:id/vote_down3b/', :to=>'attachments#vote_down3b'
...
match '/attachments/:id/vote_up4b/', :to=>'attachments#vote_up4b'
match '/attachments/:id/vote_down4b/', :to=>'attachments#vote_down4b'
...
match '/attachments/:id/vote_up5b/', :to=>'attachments#vote_up5b'
match '/attachments/:id/vote_down5b/', :to=>'attachments#vote_down5b'
...
match '/attachments/:id/vote_up6b/', :to=>'attachments#vote_up6b'
match '/attachments/:id/vote_down6b/', :to=>'attachments#vote_down6b'
...
match '/attachments/:id/vote_up7b/', :to=>'attachments#vote_up7b'
match '/attachments/:id/vote_down7b/', :to=>'attachments#vote_down7b'
...
match '/users/:id/course2b', :to=>'users#course2b'
...
match '/users/:id/course3b', :to=>'users#course3b'
...
match '/users/:id/course4b', :to=>'users#course4b'
...
match '/users/:id/course5b', :to=>'users#course5b'
...
match '/users/:id/course6b', :to=>'users#course6b'
...
match '/users/:id/course7b', :to=>'users#course7b'
...
match '/favourites/fvb/',:to=>'favourites#fvb'
